...
public class TabSmartContacts_Fragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(final LayoutInflater inflater,
		...
		ListContacts_Adapter adapter = new ListContacts_Adapter(context,
...
//							reload();
	...
	public void reload() {
		getActivity().finish();
		Intent go2 = new Intent(context,MainLayout_Activity.class);
