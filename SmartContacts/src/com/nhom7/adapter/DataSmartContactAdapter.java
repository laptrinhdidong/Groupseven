...
public class DataSmartContactAdapter extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE "+TABLE_NAME+"(SMID INTEGER PRIMARY KEY AUTOINCREMENT, SMNAME TEXT, SMPHONENUMBER TEXT, SMEMAIL TEXT)");
    }
    ...
    public boolean UpdateData(String smid, String smname, String smphone, String smemail)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
    ...
    {
    	SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("SELECT * FROM "+TABLE_NAME+" WHERE SMPHONENUMBER = "+phonenumber,null);
        return res;
    }
